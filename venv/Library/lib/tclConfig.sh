...
# installed.
TCL_PREFIX='E:/End to End LLM and Large Image model Application using Gemini Pro/venv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='E:/End to End LLM and Large Image model Application using Gemini Pro/venv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='E:/End to End LLM and Large Image model Application using Gemini Pro/venv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IE:/End to End LLM and Large Image model Application using Gemini Pro/venv\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LE:/End to End LLM and Large Image model Application using Gemini Pro/venv\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='E:/End to End LLM and Large Image model Application using Gemini Pro/venv\Library\lib\tclstub86.lib'
